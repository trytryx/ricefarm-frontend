...
import { Heading, Card, CardBody, Flex, ArrowForwardIcon, Skeleton, Text } from '@ricefarm/uikitv2'
    ...
    <StyledFarmStakingCard>
      <NavLink exact activeClassName="active" to="/lottery" id="lottery-pot-cta">
        <CardBody>
          ...
          <PrizeText color="#1baad3" fontSize="40px" bold lineHeight="1.1">
            {over}
          </PrizeText>
          {prizeInBusd.isNaN() ? (
            <>
            ...
            <Balance fontSize="40px" color="#1baad3" bold lineHeight="1.1" prefix="$" decimals={0} value={prizeTotal} />
          )}
