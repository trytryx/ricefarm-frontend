...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@ricefarm/uikitv2'
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      if (receipt.status) {
        toastSuccess(
          t('Prizes Collected!'),
          t('Your RICE prizes for round %lotteryId% have been sent to your wallet', { lotteryId }),
        )
        setPendingTx(false)
