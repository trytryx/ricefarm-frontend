const config = [
  {
    ...
    description: [
      'In the TeslaSafe Sale, every user can commit a maximum of about 5000 USD worth of TeslaSafe-BNB LP Tokens. We calculate the maximum LP amount about 30 minutes before each IFO. The TeslaSafe Sale has no participation fee.',
